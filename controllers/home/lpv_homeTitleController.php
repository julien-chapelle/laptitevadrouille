...
if (isset($_GET['url']) && $_GET['url'] == '' || isset($_GET['view']) && $_GET['view'] == 'accueil' || empty($_GET)) {
    ...
    return;
} elseif (isset($_GET['user']) && $_GET['user'] == 'editInfo' && isset($_GET['id']) && $_GET['id'] != '') {
    echo 'Modification des informations';
    return;
} elseif (isset($_GET['user']) && $_GET['user'] == 'editPassword' && isset($_GET['id']) && $_GET['id'] != '') {
    echo 'Modification du mot de passe';
    return;
} elseif (isset($_GET['user']) && $_GET['user'] == 'delete' && isset($_GET['id']) && isset($_GET['id']) && $_GET['id'] != '') {
    ...
    return;
} elseif (isset($_SESSION) && !empty($_SESSION) && isset($_SESSION['status']) && $_SESSION['status'] == 'admin' && isset($_GET['walk']) && $_GET['walk'] == 'delete' && isset($_GET['id']) && $_GET['id'] != '') {
