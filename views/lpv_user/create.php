...
<form class="p-4" method="POST" action="">
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            ...
            <input title="Renseignez le prénom ou le pseudo" placeholder="ex: Jean" type="text" class="form-control text-center" name="pseudo" id="pseudo" value="<?= !empty($arrayError) && isset($_POST['pseudo']) ? $_POST['pseudo'] : '' ?>" />
    ...
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            <label class="font-weight-bold text-dark" for="email"><i class="fas fa-at"></i>
                EMAIL</label>
            <input title="Renseignez l'adresse email" placeholder="ex: JeanDupont@wanadoo.fr" type="email" class="form-control text-center" name="mail" id="email" value="<?= !empty($arrayError) && isset($_POST['mail']) ? $_POST['mail'] : '' ?>" />
