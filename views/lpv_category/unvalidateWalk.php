<div class="row m-0 mt-1 p-2">
    <div class="col p-0 text-left">
        <a class="btn btn-outline-success px-3 shadow" href="http://laptitevadrouille/index.php?user=detail" title="Retour vers liste des sorties"><i class="fas fa-reply"></i></a>
    </div>
</div>
