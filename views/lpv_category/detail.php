<div class="card-columns px-3 mt-4">
    ...
    ?>
        <img src="assets/img_walk/<?= $row['pics'] ?>" class="img-fluid card" />
        <div class="card">
        ...
        <div class="card">
            <div class="card-body">
                <a href="<?= $row['googleMapAddress'] ?>"><img src="assets/img_map/<?= $row['map'] ?>" class="img-fluid" /></a>
                <a class="btn btn-outline-secondary btn-sm btn-block mx-0 mt-4" href="<?= $row['officialSite'] ?>">SITE OFFICIEL</a>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
