...
<form class="px-4" method="POST" action="" enctype="multipart/form-data">
    ...
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            ...
            <textarea title="Renseignez l'adresse Google Map'" placeholder="ex: https://www.google.com/maps/place/zoo..." type="text" class="form-control text-center" name="googleMapOfWalk" id="googleMapOfWalk"><?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['googleMapOfWalk'] : $detailWalk[0]['googleMapAddress'] ?></textarea>
    ...
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            <label class="font-weight-bold text-dark" for="titleOfWalk">
                TITRE</label>
            <input title="Renseignez le nom du lieu de sortie" placeholder="ex: Zoo des animaux" type="text" class="form-control text-center" name="titleOfWalk" id="titleOfWalk" value="<?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['titleOfWalk'] : $detailWalk[0]['title'] ?>" />
    ...
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            ...
            <textarea title="Décrivez rapidement la sortie" placeholder="ex: Plus de 1500 animaux sauvages..." type="text" class="form-control text-center" name="shortDescriptionOfWalk" id="shortDescriptionOfWalk"><?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['shortDescriptionOfWalk'] : $detailWalk[0]['description'] ?></textarea>
    ...
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            ...
            <textarea title="Décrivez rapidement la sortie" placeholder="ex: Plus de 1500 animaux sauvages..." type="text" class="form-control text-center" name="completeDescriptionOfWalk" id="completeDescriptionOfWalk"><?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['completeDescriptionOfWalk'] : $detailWalk[0]['moreInfoDescription'] ?></textarea>
    ...
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            ...
            <input title="Saisir le prix pour la tranche d'âge 0-3ans" placeholder="ex: 15 ou GRATUIT" type="text" class="form-control text-center" name="rate_0_3OfWalk" id="rate_0_3OfWalk" value="<?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['rate_0_3OfWalk'] : $detailWalk[0]['rate_0_3'] ?>" />
    ...
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            ...
            <input title="Saisir le prix pour la tranche d'âge 3-11ans" placeholder="ex: 15 ou GRATUIT" type="text" class="form-control text-center" name="rate_3_11OfWalk" id="rate_3_11OfWalk" value="<?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['rate_3_11OfWalk'] : $detailWalk[0]['rate_3_11'] ?>" />
    ...
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            ...
            <input title="Saisir le prix à partir de 12ans" placeholder="ex: 15 ou GRATUIT" type="text" class="form-control text-center" name="rate_12_plusOfWalk" id="rate_12_plusOfWalk" value="<?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['rate_12_plusOfWalk'] : $detailWalk[0]['rate_12_plus'] ?>" />
    ...
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            ...
            <input title="Saisir les périodes et horaires d'ouvertures" placeholder="ex: Février à Juin : de 10h00 à 17h00" type="text" class="form-control text-center" name="openedHoursOfWalk1" id="openedHoursOfWalk" value="<?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['openedHoursOfWalk1'] : $arrayDateHour[0] ?>" />
            <p class="error"><?= isset($arrayError['openedHoursOfWalk']) ? $arrayError['openedHoursOfWalk'] : '' ?></p>

            <input title="Saisir les périodes et horaires d'ouvertures" placeholder="ex: Février à Juin : de 10h00 à 17h00" type="text" class="form-control text-center" name="openedHoursOfWalk2" id="openedHoursOfWalk" value="<?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['openedHoursOfWalk2'] : $arrayDateHour[1] ?>" />
            <p class="error"><?= isset($arrayError['openedHoursOfWalk']) ? $arrayError['openedHoursOfWalk'] : '' ?></p>

            <input title="Saisir les périodes et horaires d'ouvertures" placeholder="ex: Février à Juin : de 10h00 à 17h00" type="text" class="form-control text-center" name="openedHoursOfWalk3" id="openedHoursOfWalk" value="<?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['openedHoursOfWalk3'] : $arrayDateHour[2] ?>" />
            <p class="error"><?= isset($arrayError['openedHoursOfWalk']) ? $arrayError['openedHoursOfWalk'] : '' ?></p>

            <input title="Saisir les périodes et horaires d'ouvertures" placeholder="ex: Février à Juin : de 10h00 à 17h00" type="text" class="form-control text-center" name="openedHoursOfWalk4" id="openedHoursOfWalk" value="<?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['openedHoursOfWalk4'] : $arrayDateHour[3] ?>" />
            <p class="error"><?= isset($arrayError['openedHoursOfWalk']) ? $arrayError['openedHoursOfWalk'] : '' ?></p>
        </div>
    </div>
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            <label class="font-weight-bold text-dark" for="officialSiteOfWalk">
                SITE OFFICIEL</label>
            <input title="Indiquez l'adresse du site officiel" placeholder="ex: www.zoo.com" type="text" class="form-control text-center" name="officialSiteOfWalk" id="officialSiteOfWalk" value="<?= !empty($arrayError) && isset($_POST['validateWalk']) ? $_POST['officialSiteOfWalk'] : $detailWalk[0]['officialSite'] ?>" />
    ...
    <div class="row text-center m-0 mt-1 justify-content-center">
        <div class="col-12">
            <a class="btn btn-outline-success px-3 shadow" href="http://laptitevadrouille/index.php?user=detail" title="Retour vers info utilisateur"><i class="fas fa-reply"></i></a>
            <button class="btn btn-outline-success p-2 shadow" role="button" type="submit" name="validateWalk">MODIFIER</button>
